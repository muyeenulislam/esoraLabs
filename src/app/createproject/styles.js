const styles = {
  ...
  container:
    "h-full flex flex-col justify-between items-center pt-[64px] px-[120px]",

  header: "headers text-[48px] text-white  text-center",
  ...
  loginContainer: "py-[24px] border-t-2 flex justify-between items-center",
  loginText: `text-[16px] font-medium text-primary`,
  loginButton: `rounded-lg w-full px-[20px] py-[14px] flex justify-between items-center bg-fadedYellow outline-none`,
